"""Ingest Processor - Process inbox files into strategy documents.

This module provides the IngestProcessor class that:
...
class IngestProcessor:
    ...
    def process_inbox(self, dry_run: bool = False, force: bool = False) -> IngestSummary:
...
V4IngestResult = IngestResult
V4IngestSummary = IngestSummary
V4IngestProcessor = IngestProcessor
