...
from research_system.scripts.utils.logging_config import get_logger
from research_system.scripts.status.generate_reports import refresh_all_reports
...
class FullPipelineRunner:
    ...
    def _run_walk_forward(self, entry_id: str, entry) -> PipelineResult:
        ...
        """
        from research_system.scripts.validate.walk_forward import WalkForwardValidator
...
'''
    ...
    def _run_expert_review(self, entry, is_results: BacktestResult, oos_results: Optional[BacktestResult]) -> List[ExpertReview]:
        ...
        try:
            from research_system.agents.runner import PersonaRunner
