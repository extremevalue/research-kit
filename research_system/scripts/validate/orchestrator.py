...
from research_system.scripts.utils.logging_config import get_logger, LogContext
from research_system.scripts.utils.schema_validator import validate_hypothesis
...
class ValidationOrchestrator:
    ...
    def run_data_audit(self) -> bool:
        ...
        with LogContext(logger, "Data Audit", component_id=self.component_id):
            ...
            from research_system.scripts.validate.data_audit import audit_data_requirements, save_audit_result
    ...
    def submit_is_results(
        ...
        with LogContext(logger, "IS Testing", component_id=self.component_id):
            ...
            # Run sanity checks
            from research_system.scripts.validate.sanity_checks import check_backtest_sanity, save_sanity_result
    ...
    def run_statistical_analysis(self) -> bool:
        ...
        with LogContext(logger, "Statistical Analysis", component_id=self.component_id):
            ...
            from research_system.scripts.validate.statistical_analysis import analyze_significance, save_statistical_result
    ...
    def run_regime_analysis(self) -> bool:
        ...
        with LogContext(logger, "Regime Analysis", component_id=self.component_id):
            ...
            from research_system.scripts.validate.regime_analysis import analyze_regimes, save_regime_result
