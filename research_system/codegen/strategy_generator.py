...
class CodeGenerator:
    ...
    def _generate_from_template(self, strategy: dict[str, Any]) -> CodeGenResult:
    ...
    def _generate_from_llm(self, strategy: dict[str, Any]) -> CodeGenResult:
    ...
    def _correct_code_with_claude_cli(
        ...
        Returns:
            CodeCorrectionResult with corrected code or error
        """
        try:
...
V4CodeGenResult = CodeGenResult
V4CodeCorrectionResult = CodeCorrectionResult
V4CodeGenerator = CodeGenerator
generate_v4_code = generate_code
